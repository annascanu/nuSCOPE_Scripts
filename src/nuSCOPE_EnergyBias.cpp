...
int main(int argc, char ** argv) 
{
    ...
    if (argc < 3) 
    {
        std::cout << "Usage: \n- ./nuscope_energybias.out \n- name of the nuSCOPE .root file" << std::endl;
        return 1;
    }
    ...
    c1->SaveAs("../Test_new_plots/NuSCOPE_flux.pdf");
    ...
    c2->SaveAs("../Test_new_plots/true_energy.pdf");
    ...
    c3->SaveAs("../Test_new_plots/energy_bias.pdf");
    ...
    c3_2->SaveAs("../Test_new_plots/delta_energy_weighted.pdf");
    ...
    c4->SaveAs("../Test_new_plots/NuSCOPE_modes.pdf");
    ...
    c6->SaveAs("../Test_new_plots/NuSCOPE_deltaE_modes_split.pdf");
